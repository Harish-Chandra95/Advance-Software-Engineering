...
export class ARView {
  ...
  ionViewDidEnter() {
      ...
      WikitudePlugin.loadARchitectWorld(
         ...
         //"www/assets/07_3dModels_1_3dModelOnTarget/index.html", // (1) if you have a IR (Image Recognition) sWorld, use this
//          ["ir"], // (1) if you have a IR (Image Recognition) World, use this
          //"www/assets/08_PointOfInterest_1_PoiAtLocation/index.html",
